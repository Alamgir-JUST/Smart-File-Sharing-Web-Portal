...
<body oncontextmenu="return false;">
	<div class="starting">
		<h2>You can discuss with other Faculty Members</h2>
		<hr class="style13">
	</div>
	<div class="tabledata">
		<%@include file="autoscrollingtablefaculty.jsp" %>
		<hr class="style13">
	</div>
	
	<div class="message_part">
	<form action="discussion_serv" method="post" enctype="multipart/form-data">
		<table align="center">
			<tr>
